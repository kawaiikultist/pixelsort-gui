use std::{io::Write, thread::Thread};
...
pub(crate) trait Path {
    fn get_intervals(&self, image: &ImageBuffer<Rgb<u8>, Vec<u8>>, angle: f64, threshold: Threshold) -> Vec<Interval>;
...
impl Path for RadialPath {
    ...
    // └                                                                             ┘
    fn get_intervals(&self, image: &ImageBuffer<Rgb<u8>, Vec<u8>>, _angle: f64, threshold: Threshold) -> Vec<Interval> {
        let mut intervals: Vec<Interval> = Vec::new();
